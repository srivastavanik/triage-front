          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              <p className="text-text-secondary text-[18px] leading-[1.8] mb-8">
                Triage has raised $1.5M in pre-seed funding to build an AI-native security and observability platform for teams shipping LLM-powered products. The round was led by BoxGroup, with participation from Precursor Ventures and notable angels including Michael Fertik, Zach Lloyd, David Handler, and Cory Levy, among others.
              </p>

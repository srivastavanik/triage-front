  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] selection:bg-text-primary selection:text-bg-primary">
      ...
      >
        ...
        >
          <source src="/ink-bg.mp4" type="video/mp4" />
        </video>
        {/* Overlay for contrast */}
        <div className="absolute inset-0 bg-black/30" />
        {/* Content */}
        <div className="container-max relative z-10 h-full">
          <div className="flex items-center justify-center gap-3 h-full text-[13px] text-white">
